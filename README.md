...
![Starbucks](.assets/main_screenshot.jpg)
...
![Slack Open Graph example](.assets/slack_message_og_example.jpg)

KakaoTalk -

![KakaoTalk Open Graph example](.assets/kakao_og_example.jpg)
